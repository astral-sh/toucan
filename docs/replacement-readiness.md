...
| `aws-lc-sys` with `all-bindings` | [Paired build and consumption](../corpus/evidence/aws-lc-all-bindings-7db2b85/README.md) pass the 41 crypto artifacts, six C/Rust layouts, a memory-BIO call, and 98 generated layout tests per generator. The [generated API differential](../corpus/evidence/aws-lc-all-bindings-differential-7db2b85/README.md) matches 2,618 functions and 60 globals after canonical ELF symbol matching. | Native x86-64 Linux; SSL and FIPS are disabled. Full public API equality is false: an incomplete tag's public name, three explicit padding fields, and 13 extra aliases differ. |
