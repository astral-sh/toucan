...
impl Builder {
    ...
    pub fn generate(mut self) -> Result<Bindings, BindgenError> {
        ...
        let (source, report) =
            compilation.binding_parts_with_macros(&self.options, &macros.values, macros.skipped)?;
...
impl Bindings {
    /// Keep generated sections separate until the caller writes or formats them.
    fn new(
        source: toucan::SourceParts,
        report: toucan::Report,
        options: BindingOptions,
