...
// Retain the conversion trait implemented by the upstream public API.
...
///
/// ```
/// # use toucan_layout::layout::{Record, RecordKind, RecordField, Annotation, Type, TypeVariant, BuiltinType};
/// Type::<()> {
///     layout: (),
...
///
/// ```
/// # use toucan_layout::layout::{Type, TypeVariant, Array, BuiltinType};
/// Array::<()> {
